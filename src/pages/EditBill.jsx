...
function EditBill() {
    ...
    fetch(`${API}/api/bills/${id}`)
      ...
      .then(d => {
        ...
        const mappedItems = items.map(item => ({
          name: item.name,
          price: item.price,
          sharedBy: shares.filter(s => s.item_id === item.id).map(s => s.user_id)
        }))
  ...
  return (
    <div className="page">
      <h2 style={{ marginBottom: 16 }}>✏️ Edit Bill</h2>
      ...
      <div className="card">
        ...
        {photo && (
          <div>
            <img src={photo} alt="Receipt" className="thumb" style={{ maxHeight: 200, marginBottom: 8 }} />
